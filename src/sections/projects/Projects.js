    ...
    const myProjects = [
        {
            ...
            redirect: "https://github.com/Partisi/Museum-Studies-Project"
        },
        {
        ...
        },
        {
            ...
            redirect: "https://github.com/Partisi/interactive-computing/tree/main/interactive/midterm"
        },
        {
                    ...
                    return (
                        <li key={index}>
                            ...
                            <div className="technologies-used">
                                {eachProject.redirect ? (
                                    <a href={eachProject.redirect} target="_blank" rel="noreferrer">
                                        <button className="public-proj">View <FiArrowUpRight /></button>
                                    </a>
                                ) : (
                                    <button className="private-proj">Private <FiLock /></button>
                                )}
                                <p><span className="tech-header">Technologies:</span> {eachProject.toolsUsed}</p>
                            </div>
